...
| TELEGRAM-SIMPLIFY | 텔레그램봇 단방향 관리자 알림 전용 전환 | 2026-04-11 | — | Phase A 완료(Python 리팩터+일일통계+FastAPI 5xx+blog-telegram 중지+구봇삭제). Next.js 3개 변경(가입/결제 알림)은 dev 검증 후 push 대기. cron 등록 사용자 직접 |
