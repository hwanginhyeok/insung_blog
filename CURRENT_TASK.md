...
| NEIGHBOR-AI-DISCOVER | 이웃찾기 AI 필터링 + 카탈로그 자산화 | 2026-04-11 | — | Haiku 7-flag 분류(ok/ad/ai/commercial/review_farm/inactive/low_quality). 영구차단 4개. 글로벌 캐시+사용자별 후보. 봇페이지 검토대기 UI. /admin 카탈로그. Phase 0~6 |
